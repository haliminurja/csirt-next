    ...
    <div className="bg-blue-600 rounded-3xl p-8 md:p-12 text-white relative overflow-hidden shadow-xl">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="md:w-1/3 flex justify-center md:justify-end">
          <a href="mailto:csirt@unuja.ac.id" className="px-8 py-4 bg-white text-blue-700 font-bold rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all text-center flex flex-col items-center group">
