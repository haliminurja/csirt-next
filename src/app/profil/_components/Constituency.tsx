export default function Constituency() {
  return (
    <div className="mb-24">
      <div className="bg-indigo-900 rounded-3xl p-10 md:p-16 relative overflow-hidden shadow-2xl">
        <div className="absolute top-0 right-0 w-64 h-64 bg-indigo-500 rounded-full mix-blend-multiply filter blur-[80px] opacity-40 translate-x-1/2 -translate-y-1/2" />
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-blue-500 rounded-full mix-blend-multiply filter blur-[80px] opacity-40 -translate-x-1/2 translate-y-1/2" />
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={item.title} className="bg-indigo-800/50 backdrop-blur-sm border border-indigo-700/50 rounded-2xl p-6 text-center hover:bg-indigo-800 transition-colors">
