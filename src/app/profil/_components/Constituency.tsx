      ...
      <div className="relative overflow-hidden rounded-3xl bg-indigo-900 p-10 shadow-2xl md:p-16 dark:bg-slate-900">
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={item.title} className="rounded-2xl border border-indigo-700/50 bg-indigo-800/50 p-6 text-center backdrop-blur-sm transition-colors hover:bg-indigo-800 dark:border-slate-700 dark:bg-slate-800/80 dark:hover:bg-slate-800">
