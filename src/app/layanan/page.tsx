      ...
      <div className="min-h-screen bg-white py-20 md:py-28 dark:bg-slate-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-32 relative">
            <div className="absolute -top-10 -left-10 w-64 h-64 bg-red-50 rounded-full opacity-50 pointer-events-none" />
          ...
          {/* Pilar 2: Proaktif */}
          <div className="mb-32 relative">
            <div className="absolute -top-10 -right-10 w-64 h-64 bg-indigo-50 rounded-full opacity-50 pointer-events-none" />
            <div className="flex flex-col md:flex-row items-center mb-16 relative z-10 border-b border-slate-100 pb-8">
