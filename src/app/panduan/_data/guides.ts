...
export const guideCards: GuideCard[] = [
  ...
  { id: 'ransomware', category: ['sysadmin', 'user'], title: 'SOP Darurat: Tanggap Insiden Ransomware', desc: 'Panduan prioritas tinggi saat terjadi enkripsi massal: isolasi endpoint, pengamanan bukti forensik, notifikasi berjenjang, dan pemulihan terukur tanpa membayar tebusan.', color: 'red', icon: 'M12 9v4m0 4h.01M4.93 19h14.14c1.54 0 2.5-1.67 1.73-3L13.73 4c-.77-1.33-2.69-1.33-3.46 0L3.2 16c-.77 1.33.19 3 1.73 3z', badge: 'SOP Insiden' },
